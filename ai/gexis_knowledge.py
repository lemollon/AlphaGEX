...
=== ECONOMIC EVENTS GEXIS MUST KNOW ===
...
GEXIS TRADING RULES FOR EVENTS:
...
# =============================================================================
# GEXIS COMMANDS REFERENCE
# =============================================================================

GEXIS_COMMANDS = """
=== GEXIS SLASH COMMANDS ===
...
def get_full_knowledge() -> str:
    """Get the complete GEXIS knowledge base"""
    return f"""
{DATABASE_TABLES}
