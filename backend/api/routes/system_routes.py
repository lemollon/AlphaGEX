...
async def cleanup_equity_snapshots(bot: str = None, confirm: bool = False):
    ...
    Args:
        bot: Optional specific bot to clean (ares, athena, icarus, pegasus, titan).
    ...
    # Bot configurations
    all_bots = {
        'ares': 'ares_equity_snapshots',
        'athena': 'athena_equity_snapshots',
        'icarus': 'icarus_equity_snapshots',
        'pegasus': 'pegasus_equity_snapshots',
        'titan': 'titan_equity_snapshots',
    }
