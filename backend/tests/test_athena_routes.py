"""
ATHENA Directional Spread Routes Tests

Tests for the ATHENA bot API endpoints including:
- Status endpoint
- Positions endpoint
- Signals and analysis
- Performance metrics

Run with: pytest backend/tests/test_athena_routes.py -v
"""
...
class TestAthenaStatusEndpoint:
    """Tests for /api/athena/status endpoint"""

    def test_get_status_success(self):
        """Test that status endpoint returns valid data structure"""
        response = client.get("/api/athena/status")
...
class TestAthenaPositionsEndpoint:
    ...
    def test_get_open_positions(self):
        ...
        response = client.get("/api/athena/positions?status=open")
    ...
    def test_get_closed_positions(self):
        ...
        response = client.get("/api/athena/positions?status=closed")
...
class TestAthenaPerformanceEndpoint:
    ...
    def test_performance_with_days_param(self):
        ...
        response = client.get("/api/athena/performance?days=30")
...
class TestAthenaEquityCurveEndpoint:
    """Tests for /api/athena/equity endpoint"""

    def test_get_equity_curve_success(self):
        """Test equity curve endpoint"""
        response = client.get("/api/athena/equity")
...
class TestAthenaTradesEndpoint:
    ...
    def test_trades_with_limit(self):
        ...
        response = client.get("/api/athena/trades?limit=10")
...
class TestAthenaLogsEndpoint:
    ...
    def test_logs_with_limit(self):
        ...
        response = client.get("/api/athena/logs?limit=25")
...
class TestAthenaConfigEndpoint:
    """Tests for /api/athena/config endpoint"""

    def test_get_config_success(self):
        """Test config endpoint returns configuration"""
        response = client.get("/api/athena/config")
...
class TestAthenaDataValidation:
    """Tests for data validation in ATHENA endpoints"""
