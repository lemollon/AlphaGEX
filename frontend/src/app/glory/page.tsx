...
/**
 * GLORY (Weekly Gamma) - Weekly Options Gamma Visualization (Enhanced)
 * Named after the Samson of Watchfulness - watching longer-term gamma setups
 *
 * GLORY focuses on weekly options for stocks/ETFs that don't have 0DTE,
...
export default function HyperionPage() {
    ...
    try {
      ...
      if (response.data?.success && response.data?.data) {
        ...
        if (newData.data_unavailable) {
          console.log('[GLORY] Data unavailable:', newData.reason, newData.message)
  ...
  const fetchAlerts = useCallback(async () => {
    try {
      ...
      console.error('[GLORY] Error fetching alerts:', err)
    }
  }, [selectedSymbol])
  ...
  const fetchExpirations = useCallback(async () => {
    try {
      ...
      console.error('[GLORY] Error fetching expirations:', err)
    }
  }, [selectedSymbol])
      ...
      <main className={`pt-24 px-4 sm:px-6 lg:px-8 max-w-[1600px] mx-auto pb-8 ${sidebarPadding}`}>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white">GLORY</h1>
        ...
        {loading && !gammaData && (
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-gray-400">Loading GLORY data for {selectedSymbol}...</p>
            </div>
          </div>
        )}
          ...
          <>
            ...
            <div className="bg-gradient-to-r from-purple-900/40 to-blue-900/40 border border-purple-500/30 rounded-xl p-5 mb-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <h3 className="font-bold text-white">GLORY AI Analysis</h3>
            ...
            <div className="mt-6 p-4 bg-gray-900/30 border border-gray-800 rounded-lg">
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm text-gray-400">
                  <p className="mb-1">
                    <strong className="text-purple-400">GLORY</strong> provides weekly gamma visualization for stocks and ETFs with weekly options.
                  </p>
                  <p>
                    Unlike WATCHTOWER (0DTE), GLORY focuses on longer-dated weekly expirations, helping identify
