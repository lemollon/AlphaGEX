...
const PsychologyPerformanceContent = dynamic(() => import('./PsychologyPerformanceContent'), {
  ssr: false,
  loading: () => (
...
export default function PsychologyPerformancePage() {
  return <PsychologyPerformanceContent />
}
