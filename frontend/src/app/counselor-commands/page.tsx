...
export default function CounselorCommandsPage() {
      ...
      <div className="p-6 pt-20 max-w-6xl mx-auto lg:pl-16">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-text-primary">COUNSELOR Commands Reference</h1>
          </div>
          <p className="text-text-secondary">
            Quick reference for all COUNSELOR slash commands and natural language queries.
        ...
        <div className="bg-background-card rounded-xl border border-gray-800 p-6 mb-8">
          ...
          <p className="text-text-secondary mb-4">
            COUNSELOR understands natural language. Try asking these questions:
          </p>
        ...
        <div className="bg-background-card rounded-xl border border-gray-800 p-6">
          ...
          <p className="text-text-secondary mb-4">
            COUNSELOR knows about these market-moving events and will advise accordingly:
          </p>
          ...
          <div className="mt-4 p-4 bg-warning/10 border border-warning/30 rounded-lg">
            <div className="flex items-start space-x-2">
              ...
              <div>
                <p className="text-warning font-medium">COUNSELOR Calendar Guidance</p>
                <p className="text-text-secondary text-sm mt-1">
                  Ask COUNSELOR "/calendar" or "What events are coming up?" to get a tailored trading
                  advisory based on the economic calendar. COUNSELOR will proactively warn you about
        ...
        <div className="mt-8 p-4 bg-primary/10 border border-primary/30 rounded-lg">
          <div className="flex items-start space-x-2">
            ...
            <div>
              ...
              <p className="text-text-secondary text-sm mt-1">
                COUNSELOR knows you as "Optionist Prime" and will address you personally.
                The more context you give, the better COUNSELOR can help. Try: "COUNSELOR, I'm thinking
