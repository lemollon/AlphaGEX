...
export default function GideonPage() {
  ...
  // Brand info
  const brand = BOT_BRANDS.GIDEON

  const handleRefresh = async () => {
    await Promise.all([refreshStatus(), refreshUnified()])
    addToast({ type: 'success', title: 'Refreshed', message: 'GIDEON data refreshed' })
  }
    ...
    return (
      <>
        ...
        <div className="flex items-center justify-center h-screen">
          <LoadingState message="Loading GIDEON..." />
        </div>
      </>
    )
  }
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-300 text-sm mt-1">
                    GIDEON is using the default starting capital ($100,000). For accurate P&L and return calculations,
                    configure your actual starting capital via the API.
                  </p>
                  <p className="text-gray-500 text-xs mt-2">
                    POST /api/metrics/GIDEON/capital with your actual starting capital
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  GIDEON runs with aggressive Apache GEX backtest parameters: {config?.wall_filter_pct || 2}% wall filter (vs SOLOMON 1%), {config?.min_win_probability || 48}% min win prob (vs 55%), VIX {config?.min_vix || 12}-{config?.max_vix || 30} (vs 15-25), {config?.risk_per_trade || 3}% risk/trade
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            {activeTab === 'portfolio' && (
              <>
                ...
                <DriftStatusCard botName="GIDEON" />

                {/* Equity Curve */}
                <EquityCurveChart
                  title="GIDEON Equity Curve"
                  botFilter="GIDEON"
                  ...
                  <div className="flex justify-end mb-4">
                    <button
                      onClick={() => {
                        ...
                        exportTradesToCSV(closedPositions, `gideon-trades-${today}.csv`)
              ...
              <BotCard title="Configuration (Apache GEX Backtest - Aggressive)" icon={<Settings className="h-5 w-5" />}>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-orange-900/20 border border-orange-500/30 rounded-lg p-4">
                    ...
                    <span className="text-xs text-gray-500 block mt-1">vs SOLOMON 1%</span>
                  </div>
                  <div className="bg-orange-900/20 border border-orange-500/30 rounded-lg p-4">
                    ...
                    <span className="text-xs text-gray-500 block mt-1">vs SOLOMON 55%</span>
                  </div>
                  <div className="bg-orange-900/20 border border-orange-500/30 rounded-lg p-4">
                    ...
                    <span className="text-xs text-gray-500 block mt-1">vs SOLOMON 1.5:1</span>
                  </div>
                  <div className="bg-orange-900/20 border border-orange-500/30 rounded-lg p-4">
                    ...
                    <span className="text-xs text-gray-500 block mt-1">vs SOLOMON 2%</span>
                  </div>
                  {/* VIX Filter */}
                  <div className="bg-orange-900/20 border border-orange-500/30 rounded-lg p-4">
                    ...
                    <span className="text-xs text-gray-500 block mt-1">vs SOLOMON 15-25</span>
                  </div>
                  {/* GEX Ratio */}
                  <div className="bg-orange-900/20 border border-orange-500/30 rounded-lg p-4">
                    ...
                    <span className="text-xs text-gray-500 block mt-1">vs SOLOMON &gt;1.5</span>
                  </div>
                  <div className="bg-orange-900/20 border border-orange-500/30 rounded-lg p-4">
                    ...
                    <span className="text-xs text-gray-500 block mt-1">vs SOLOMON &lt;0.67</span>
                  </div>
                  {/* Trade Limits */}
                  <div className="bg-gray-800/50 rounded-lg p-4">
                    ...
                    <span className="text-xs text-gray-500 block mt-1">vs SOLOMON 5</span>
                  </div>
                  <div className="bg-gray-800/50 rounded-lg p-4">
                    ...
                    <span className="text-xs text-gray-500 block mt-1">vs SOLOMON 3</span>
                  </div>
                  <div className="bg-gray-800/50 rounded-lg p-4">
                  ...
                  <div className="bg-gray-800/50 rounded-lg p-4">
                    ...
                    <span className="text-xs text-gray-500 block mt-1">vs SOLOMON 50%</span>
                  </div>
                  <div className="bg-gray-800/50 rounded-lg p-4">
