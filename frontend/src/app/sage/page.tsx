...
export default function SagePage() {
  ...
  // Use SAGE-specific endpoints for ML Advisor data
  ...
  const { data: featuresData, isLoading: featuresLoading, mutate: mutateFeatures } = useSWR<{ data: { features: Feature[] } }>(
    activeTab === 'features' ? '/api/ml/sage/feature-importance' : null,
    fetcher
  )
  ...
  const handleTrain = async () => {
    setTraining(true)
    try {
      await api.post('/api/ml/sage/train', { min_samples: 30, use_kronos: true })
      mutateStatus()
      mutateQuality()
      mutateFeatures()
    } catch (e) {
  ...
  const handlePredict = async (e: React.FormEvent) => {
    ...
    try {
      const response = await api.post('/api/ml/sage/predict', {
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h2 className="text-xl font-semibold text-white">
                          {status?.model_trained && status?.should_trust_predictions
                            ? 'SAGE is Active & Trusted'
                            : status?.model_trained
                              ? 'SAGE is Active (Limited Trust)'
                              : 'SAGE Needs Training'}
                        </h2>
                    ...
                    <div className="bg-gray-800 rounded-lg p-6 border border-green-900/50">
                      ...
                      <ul className="space-y-2">
                        {(status?.what_ml_can_do || [
                          ...
                          'Learn from KRONOS backtest results',
              ...
              {activeTab === 'predictions' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                    ...
                    <p className="text-gray-400 text-sm mb-4">
                      Enter market conditions to get SAGE's ML prediction for Iron Condor trading.
                    </p>
                    ...
                    {!status?.model_trained && (
                      <div className="mt-4 p-4 bg-yellow-900/30 border border-yellow-700 rounded-lg flex items-center gap-3">
                        ...
                        <p className="text-yellow-300">
                          SAGE model is not trained yet. Train the model first to get predictions.
                        </p>
                      </div>
                    )}
                  </div>

                  {/* How SAGE Makes Decisions */}
                  <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                    <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className="bg-gray-900 rounded-lg p-4">
                        ...
                        <p className="text-gray-400 text-sm">
                          Trained on KRONOS backtest results, the model predicts win probability with calibrated confidence.
                        </p>
                      </div>
                      <div className="bg-gray-900 rounded-lg p-4">
                        <div className="flex items-center gap-2 mb-2">
                ...
                <div className="space-y-6">
                  <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                    ...
                    <p className="text-gray-400 text-sm mb-6">
                      These are the factors SAGE uses to predict trade outcomes, ranked by importance.
                    </p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                    ...
                    <p className="text-gray-400 mb-4">
                      SAGE uses calibrated probabilities to ensure that when it says "70% win probability",
                ...
                <div className="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                  <div className="p-4 border-b border-gray-700 flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Full transparency on all SAGE decisions</p>
                    </div>
                    <div className="flex items-center gap-3">
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-gray-900 rounded-lg p-4 border border-gray-700">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <h4 className="text-white font-medium">KRONOS Backtests</h4>
                        </div>
                        <p className="text-gray-400 text-sm">
                      ...
                      <div className="bg-gray-900 rounded-lg p-4 border border-gray-700">
                        ...
                        <p className="text-gray-400 text-sm">
                          Feedback loop from ARES, PEGASUS, and TITAN live trades for continuous improvement.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  {strategy && (
                    <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                      ...
                      <div className="space-y-4">
                        <div>
                          <h4 className="text-emerald-400 font-medium mb-2">What SAGE Learned</h4>
