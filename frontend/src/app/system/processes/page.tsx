...
const ALL_PROCESSES = [
  ...
  { id: 'discernment', title: 'DISCERNMENT Bot', category: 'bots', keywords: ['discernment', 'scanner'], type: 'bot' as NodeType },
  { id: 'watchtower', title: 'WATCHTOWER Bot', category: 'bots', keywords: ['watchtower', 'gamma'], type: 'bot' as NodeType },
  { id: 'prophet', title: 'PROPHET Bot', category: 'bots', keywords: ['prophet', 'ml'], type: 'bot' as NodeType },
  { id: 'jubilee', title: 'JUBILEE Bot', category: 'bots', keywords: ['jubilee', 'training'], type: 'bot' as NodeType },
  { id: 'lazarus', title: 'LAZARUS Bot', category: 'bots', keywords: ['lazarus', 'recovery'], type: 'bot' as NodeType },
  { id: 'shepherd', title: 'SHEPHERD Bot', category: 'bots', keywords: ['shepherd', 'data'], type: 'bot' as NodeType },
  { id: 'cornerstone', title: 'CORNERSTONE Bot', category: 'bots', keywords: ['cornerstone', 'portfolio'], type: 'bot' as NodeType },
  { id: 'proverbs', title: 'PROVERBS Bot', category: 'bots', keywords: ['proverbs', 'feedback', 'loop', 'optimization', 'self-improving'], type: 'bot' as NodeType },
  { id: 'claude-ai', title: 'Claude AI Intelligence', category: 'ai', keywords: ['claude', 'counselor'], type: 'ai' as NodeType },
...
export default function SystemProcessesPage() {
  ...
  const bots = useMemo(() => [
    ...
    { name: 'DISCERNMENT', icon: '☀️', description: 'AI Scanner', status: botStatuses['discernment']?.status || 'stopped', pnl: 0 },
    { name: 'WATCHTOWER', icon: '👁️', description: 'Gamma Monitor', status: botStatuses['watchtower']?.status || 'stopped', pnl: 0 },
    { name: 'PROPHET', icon: '🔮', description: 'ML Predictions', status: botStatuses['prophet']?.status || 'stopped', pnl: 0 },
    { name: 'JUBILEE', icon: '🔥', description: 'ML Training', status: botStatuses['jubilee']?.status || 'stopped', pnl: 0 },
    { name: 'LAZARUS', icon: '🦅', description: 'Recovery Bot', status: botStatuses['lazarus']?.status || 'stopped', pnl: 0 },
    { name: 'SHEPHERD', icon: '📨', description: 'Data Flow', status: botStatuses['shepherd']?.status || 'stopped', pnl: 0 },
    { name: 'CORNERSTONE', icon: '🗺️', description: 'Portfolio Manager', status: botStatuses['cornerstone']?.status || 'stopped', pnl: 0 },
    { name: 'PROVERBS', icon: '📖', description: 'Feedback Loop Intelligence', status: botStatuses['proverbs']?.status || 'stopped', pnl: 0 },
  ], [botStatuses]);
