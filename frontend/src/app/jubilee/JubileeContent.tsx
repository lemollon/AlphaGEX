...
// ==============================================================================
// EQUITY TIMEFRAME OPTIONS (matching VALOR)
// ==============================================================================
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="bg-[#0a0a0a] rounded-xl border border-emerald-500/30 p-4">
            ...
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="text-sm font-medium text-white">JUBILEE P&L Summary</h3>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-400">Loading JUBILEE data...</p>
          </div>
        )}

        {isError && (
          <div className="bg-red-900/50 border border-red-700 rounded-lg p-6 text-center">
            <p className="text-red-300">Failed to load JUBILEE data</p>
          </div>
        )}
          ...
          <>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-emerald-900/20 rounded-lg p-4 border border-emerald-600/30">
                  <details className="group" open>
                    <summary className="flex items-center justify-between cursor-pointer text-emerald-400 font-medium">
                      <span>How JUBILEE Makes Money</span>
                ...
                <div className="bg-gradient-to-r from-gray-800 via-gray-800 to-gray-800 rounded-lg p-6 border border-orange-500/30">
                  <h2 className="text-xl font-bold mb-4 flex items-center gap-2">
                    ...
                    <span className="text-sm font-normal text-gray-400">- How capital moves through JUBILEE</span>
                  </h2>
                ...
                <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-gray-700/50 rounded-lg p-4">
                      ...
                      <div className="mt-2 text-xs text-gray-400">
                        JUBILEE uses borrowed capital to fund IC margin requirements
                      </div>
                    </div>
                    <div className="bg-gray-700/50 rounded-lg p-4">
                        ...
                        <div className="space-y-3">
                          <div className="bg-black/30 rounded-lg p-3">
                            <div className="flex justify-between items-center">
                              <span className="text-orange-400 font-medium">🔥 JUBILEE IC Trading</span>
                ...
                {(!positions?.positions || positions.positions.length === 0) && (
                  <div className="space-y-6">
                    ...
                    <div className="bg-gradient-to-br from-orange-900/30 to-gray-800 rounded-lg p-6 border border-orange-500/50">
                      <div className="flex items-center justify-between mb-4">
                        <h2 className="text-2xl font-bold">JUBILEE Ready</h2>
                ...
                {/* JUBILEE IC Trading Status */}
                <div className="bg-gray-800 rounded-lg p-6">
                  <div className="flex justify-between items-center mb-4">
                    <h2 className="text-xl font-bold">JUBILEE IC Trading</h2>
                ...
                <div className="bg-gray-800 rounded-lg overflow-hidden">
                  ...
                  {positions?.positions?.length > 0 ? (
                    ...
                    <div className="p-8 text-center text-gray-400">
                      ...
                      <p className="text-sm mt-2">JUBILEE scans for opportunities starting at market open (8:30 AM CT)</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            {activeTab === 'ic-trading' && (
              <div className="space-y-6">
                ...
                {/* IC TRADING Equity Curve - SHORT-TERM AGGRESSIVE (like ANCHOR) */}
                <div className="bg-gray-800 rounded-lg p-6 border-l-4 border-green-500">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    {/* Timeframe Selector - matching VALOR */}
                  ...
                  {(isIcIntraday ? icIntradayLoading : icEquityCurveLoading) ? (
                    ...
                    return chartData.length > 0 ? (
                      <>
                        ...
                        {/* Recharts LineChart - matching VALOR style */}
                        <div className="h-64">
            ...
            {activeTab === 'analytics' && (
              <div className="space-y-6">
                ...
                {/* JUBILEE IC Trading Performance */}
                <div className="bg-gray-800 rounded-lg p-6">
                  <h2 className="text-xl font-bold mb-4">JUBILEE IC Trading Performance</h2>
                  <div className="grid md:grid-cols-3 gap-4">
                    {/* IC Statistics */}
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gradient-to-r from-orange-900/50 via-red-900/30 to-orange-900/50 rounded-xl p-8 border border-orange-500/30">
                  <div className="text-center mb-6">
                    <h1 className="text-4xl font-bold text-white mb-2">JUBILEE</h1>
                  ...
                  <div className="grid md:grid-cols-3 gap-4 mb-8">
                    ...
                    <div className="relative">
                      <div className="bg-gradient-to-br from-orange-900/50 to-orange-800/30 rounded-xl p-6 border border-orange-500/30 h-full">
                        ...
                        <div className="bg-black/40 rounded-lg p-4">
                          <div className="text-sm text-center mb-3 text-gray-300">JUBILEE IC Trading</div>
                          <div className="space-y-3">
                            <div className="relative">
                ...
                <div className="bg-gray-800 rounded-xl p-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {[
                      ...
                      { icon: '⚠️', title: 'IC Bot Underperformance', desc: 'JUBILEE only profits if IC bot returns exceed borrowing costs. A losing streak means paying interest with no gains.' },
                    ].map((risk, idx) => (
                ...
                {/* How JUBILEE Manages This */}
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 border border-orange-500/20">
                  <h2 className="text-2xl font-bold mb-6 text-orange-400">How JUBILEE Manages Risk</h2>
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gradient-to-r from-purple-900/50 via-indigo-900/30 to-purple-900/50 rounded-xl p-8 border border-purple-500/30">
                  <div className="text-center mb-4">
                    <h1 className="text-4xl font-bold text-white mb-2">JUBILEE System Flow</h1>
                    <p className="text-xl text-purple-300">Complete Operational Reference Guide</p>
                    <p className="text-gray-400 mt-2 max-w-2xl mx-auto">
                      This reference shows exactly how JUBILEE operates from market open to close.
...
┌─────────────────────────────────────────────────────────────────────────────┐
│                    JUBILEE IC TRADING CYCLE                               │
│                    (Follows ANCHOR Trading Rules)                           │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  ┌─────────────────┐                                                        │
...
│           ▼                                                                 │
│  ┌─────────────────┐        ┌─────────────────────────────────────────┐     │
│  │ MARKET CHECK    │        │  VIX FILTER (from ANCHOR rules):       │     │
...
`}</pre>
                  ...
                  {/* ANCHOR Rules Reference */}
                  <div className="bg-orange-900/20 rounded-lg p-4 border border-orange-600/30 mb-4">
                    <h4 className="font-bold text-orange-400 mb-3">ANCHOR Trading Rules (Used by JUBILEE IC)</h4>
                    <div className="grid md:grid-cols-3 gap-4 text-sm">
                      <div className="bg-black/30 rounded-lg p-3">
...
┌─────────────────────────────────────────────────────────────────────────────┐
│  JUBILEE - DAILY P&L BREAKDOWN (Last 14 Days)                            │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
                ...
                <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl p-6 border border-orange-500/20">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-black/30 rounded-lg p-4 border border-orange-700/30">
                      <h4 className="font-bold text-orange-400 mb-3">IC Trading Settings (ANCHOR Rules)</h4>
                      <div className="space-y-2 text-sm font-mono">
                        <div className="flex justify-between">
