...
const navItems = [
  ...
  { href: '/prometheus-box', label: 'PROMETHEUS (Box Spreads)', icon: Flame, category: 'Live Trading' },
  { href: '/heracles', label: 'HERACLES (MES Futures)', icon: Activity, category: 'Live Trading' },
