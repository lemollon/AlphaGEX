...
const navItems = [
  ...
  { href: '/gex-ml', label: 'ORION (GEX ML)', icon: Brain, category: 'AI & Testing' },
  ...
  { href: '/ares/reports', label: 'ARES Reports', icon: FileText, category: 'Bot Reports' },
  { href: '/athena/reports', label: 'ATHENA Reports', icon: FileText, category: 'Bot Reports' },
  { href: '/icarus/reports', label: 'ICARUS Reports', icon: FileText, category: 'Bot Reports' },
  { href: '/pegasus/reports', label: 'PEGASUS Reports', icon: FileText, category: 'Bot Reports' },
  { href: '/titan/reports', label: 'TITAN Reports', icon: FileText, category: 'Bot Reports' },
  ...
  { href: '/nexus', label: 'NEXUS (Neural Network)', icon: Sparkles, category: 'Main' },
