...
const navItems = [
  ...
  { href: '/agape-eth-perp', label: `${BOT_DISPLAY_NAMES.AGAPE_ETH_PERP} (ETH Perpetual)`, icon: Globe, category: 'Perpetuals' },
  { href: '/agape-btc-perp', label: `${BOT_DISPLAY_NAMES.AGAPE_BTC_PERP} (BTC Perpetual)`, icon: Globe, category: 'Perpetuals' },
  { href: '/agape-xrp-perp', label: `${BOT_DISPLAY_NAMES.AGAPE_XRP_PERP} (XRP Perpetual)`, icon: Globe, category: 'Perpetuals' },
  { href: '/agape-doge-perp', label: `${BOT_DISPLAY_NAMES.AGAPE_DOGE_PERP} (DOGE Perpetual)`, icon: Globe, category: 'Perpetuals' },
  { href: '/agape-shib-perp', label: `${BOT_DISPLAY_NAMES.AGAPE_SHIB_PERP} (SHIB Perpetual)`, icon: Globe, category: 'Perpetuals' },
