...
const navItems = [
  ...
  { href: '/agape', label: `${BOT_DISPLAY_NAMES.AGAPE} (ETH Futures)`, icon: TrendingUp, category: 'Futures Crypto' },
  { href: '/agape-btc', label: `${BOT_DISPLAY_NAMES.AGAPE_BTC} (BTC Futures)`, icon: TrendingUp, category: 'Futures Crypto' },
  { href: '/agape-xrp', label: `${BOT_DISPLAY_NAMES.AGAPE_XRP} (XRP Futures)`, icon: TrendingUp, category: 'Futures Crypto' },
