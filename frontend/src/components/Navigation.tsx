...
const navItems = [
  ...
  { href: '/gex-profile', label: 'GEX Profile', icon: BarChart3, category: 'Analysis' },
  ...
  { href: '/perpetuals-crypto', label: 'Perpetuals Crypto (ETH/BTC/XRP/DOGE/SHIB)', icon: TrendingUp, category: 'Perpetuals Crypto' },
  { href: '/agape-eth-perp', label: `${BOT_DISPLAY_NAMES.AGAPE_ETH_PERP} (ETH Perp)`, icon: Globe, category: 'Perpetuals Crypto' },
  { href: '/agape-btc-perp', label: `${BOT_DISPLAY_NAMES.AGAPE_BTC_PERP} (BTC Perp)`, icon: Globe, category: 'Perpetuals Crypto' },
  { href: '/agape-xrp-perp', label: `${BOT_DISPLAY_NAMES.AGAPE_XRP_PERP} (XRP Perp)`, icon: Globe, category: 'Perpetuals Crypto' },
  { href: '/agape-doge-perp', label: `${BOT_DISPLAY_NAMES.AGAPE_DOGE_PERP} (DOGE Perp)`, icon: Globe, category: 'Perpetuals Crypto' },
  { href: '/agape-shib-perp', label: `${BOT_DISPLAY_NAMES.AGAPE_SHIB_PERP} (SHIB Perp)`, icon: Globe, category: 'Perpetuals Crypto' },
