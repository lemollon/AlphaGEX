...
const navItems = [
  ...
  { href: '/sage', label: `${ADVISOR_DISPLAY_NAMES.SAGE} (ML Advisor)`, icon: Brain, category: 'AI & Testing' },
  ...
  { href: '/prometheus', label: `${BOT_DISPLAY_NAMES.PROMETHEUS} (ML System)`, icon: Flame, category: 'AI & Testing' },
  ...
  { href: '/ares', label: `${BOT_DISPLAY_NAMES.ARES} (SPY Iron Condor)`, icon: Sword, category: 'Live Trading' },
  { href: '/athena', label: `${BOT_DISPLAY_NAMES.ATHENA} (Directional Spreads)`, icon: Target, category: 'Live Trading' },
  { href: '/icarus', label: `${BOT_DISPLAY_NAMES.ICARUS} (Aggressive Directional)`, icon: Flame, category: 'Live Trading' },
  ...
  { href: '/prometheus-box', label: `${BOT_DISPLAY_NAMES.PROMETHEUS} (Box Spreads)`, icon: Flame, category: 'Live Trading' },
  ...
  { href: '/trader', label: `${BOT_DISPLAY_NAMES.PHOENIX} (SPY 0DTE)`, icon: Bot, category: 'Beta' },
  { href: '/wheel', label: `${BOT_DISPLAY_NAMES.HERMES} (Manual Wheel)`, icon: RotateCcw, category: 'Beta' },
  { href: '/spx-wheel', label: `${BOT_DISPLAY_NAMES.ATLAS} (SPX Wheel)`, icon: Target, category: 'Beta' },
  { href: '/spx', label: 'SPX Institutional', icon: TrendingUp, category: 'Beta' },
  { href: '/gexis-commands', label: `${ADVISOR_DISPLAY_NAMES.GEXIS} Commands`, icon: MessageSquare, category: 'System' },
  ...
  { href: '/nexus', label: `${ADVISOR_DISPLAY_NAMES.NEXUS} (Neural Network)`, icon: Sparkles, category: 'Main' },
