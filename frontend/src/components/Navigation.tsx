...
const navItems = [
  ...
  { href: '/agape-btc', label: `${BOT_DISPLAY_NAMES.AGAPE_BTC} (BTC Futures)`, icon: TrendingUp, category: 'Live Trading' },
  { href: '/agape-xrp', label: `${BOT_DISPLAY_NAMES.AGAPE_XRP} (XRP Futures)`, icon: TrendingUp, category: 'Live Trading' },
