...
import CovenantCanvas, { BotStatus } from './CovenantCanvas'

// =============================================================================
// TYPES
// =============================================================================

interface CovenantLoadingScreenProps {
...
export default function CovenantLoadingScreen({
  message = 'Initializing COVENANT',
  ...
  return (
    <div className="fixed inset-0 z-50 bg-background-deep flex flex-col">
      {/* COVENANT Canvas - Full Screen Background */}
