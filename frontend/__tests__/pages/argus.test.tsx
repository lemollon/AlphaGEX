/**
 * ARGUS Page Component Tests
 *
 * Comprehensive tests for the ARGUS 0DTE Gamma Visualization page.
...
describe('ARGUS Safe Utility Functions', () => {
...
describe('ARGUS API Response Handling', () => {
  beforeEach(() => {
    jest.clearAllMocks()
  ...
  describe('1. gammaData (strikes, magnets, danger_zones, warnings)', () => {
    const setupGammaDataMock = (gammaData: unknown) => {
      mockApiClient.get.mockImplementation((url: string) => {
        if (url.includes('/argus/snapshot')) {
          return Promise.resolve({ data: { data: gammaData } })
        }
        if (url.includes('/argus/expirations')) {
...
describe('ARGUS Combined Edge Cases', () => {
