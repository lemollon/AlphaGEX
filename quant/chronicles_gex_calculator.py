"""
CHRONICLES GEX Calculator - Calculate Historical GEX from ORAT Options Data
========================================================================

PURPOSE:
Calculate Gamma Exposure (GEX) from ORAT historical options data used by CHRONICLES.
This enables:
...
class KronosGEXCalculator:
    ...
    Uses the same database as CHRONICLES backtester but focuses on
    ...
    def calculate_gex(self, ticker: str = None) -> Optional[Dict[str, Any]]:
        ...
        Args:
            ticker: Ignored for Chronicles (always uses SPX from ORAT database)
    ...
    def enrich_backtest_with_gex(
        ...
        """
        Add GEX data to existing CHRONICLES backtest results.
...
if __name__ == "__main__":
    ...
    if args.date:
        ...
        print("Usage:")
        print("  Single date:   python chronicles_gex_calculator.py --date 2024-01-15")
        print("  Time series:   python chronicles_gex_calculator.py --start 2024-01-01 --end 2024-12-01")
