"""
JUBILEE Models - Box Spread Synthetic Borrowing
...
class CapitalDeployment:
    ...
    ================================
    1. JUBILEE sells box spreads → receives cash
    ...
    anchor_allocation_reasoning: str
        ...
        return {
            ...
            'allocations': {
                ...
                'anchor': {
                    ...
                    'pct': self.anchor_allocation_pct,
                    'reasoning': self.anchor_allocation_reasoning,
                    'returns': self.anchor_returns_to_date,
                },
                'reserve': {
...
class JubileeConfig:
    """
    JUBILEE configuration with educational annotations.
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> 'JubileeConfig':
...
class DailyBriefing:
    """
    Daily status briefing for JUBILEE system.
...
# ==============================================================================
# JUBILEE IC TRADING MODELS
# ==============================================================================
# These models support JUBILEE's own Iron Condor trading using borrowed capital.
# Instead of deploying to FORTRESS/SAMSON/ANCHOR, JUBILEE trades its own ICs.
# ==============================================================================
...
class JubileeICSignal:
    ...
    JUBILEE uses borrowed capital to trade ICs, aiming to earn more
...
class JubileeICConfig:
    ...
    =========================================
    These settings control how JUBILEE trades Iron Condors
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            'sizing': {
                ...
                'max_daily_trades': self.max_daily_trades,  # Now limited like ANCHOR
