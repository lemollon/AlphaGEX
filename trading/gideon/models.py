...
All data classes for GIDEON aggressive directional spread trading.

GIDEON uses MORE AGGRESSIVE Apache GEX backtest parameters than SOLOMON:
...
Safety filters ARE ENABLED (unlike old GIDEON with everything disabled).
"""
...
class GideonConfig:
    """
    GIDEON configuration with AGGRESSIVE Apache GEX backtest parameters.
