...
Data models for TITAN aggressive SPX Iron Condor trading bot.

TITAN is an aggressive version of PEGASUS:
...
class StrategyPreset(Enum):
    """Strategy presets for TITAN aggressive trading"""
...
class IronCondorPosition:
    ...
    Same structure as PEGASUS but with TITAN context.
    """
    # Identity
    position_id: str
    ticker: str = "SPX"
    ...
    # Position sizing
    contracts: int = 1
    spread_width: float = 12.0  # TITAN uses $12 spreads (vs $10 for PEGASUS)
...
class TITANConfig:
    """
    TITAN configuration for aggressive SPX trading.
...
class IronCondorSignal:
    ...
    oracle_suggested_sd: float = 0.8  # TITAN default
    oracle_use_gex_walls: bool = False
    ...
    def is_valid(self) -> bool:
        ...
        return (
            self.confidence >= 0.4 and  # Lower threshold for TITAN (PEGASUS: 0.5)
