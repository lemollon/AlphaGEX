"""
AGAPE-DOGE Models - Data structures for the DOGE Perpetual Contract bot.
...
@dataclass
class AgapeDogeConfig:
    """Configuration for AGAPE-DOGE bot.
    ...
    @classmethod
    def load_from_db(cls, db) -> "AgapeDogeConfig":
...
@dataclass
class AgapeDogeSignal:
    """Trading signal generated by AGAPE-DOGE signal engine."""
    spot_price: float
    timestamp: datetime
...
@dataclass
class AgapeDogePosition:
    """An open or closed AGAPE-DOGE position."""
    position_id: str
    side: PositionSide
    quantity: float
    entry_price: float
