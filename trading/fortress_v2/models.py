"""
FORTRESS V2 - Data Models
======================

Clean, minimal data models for FORTRESS Iron Condor trading bot.
Single source of truth for all position and configuration data.

FORTRESS trades SPY Iron Condors - both Bull Put and Bear Call spreads.
"""
...
class FortressConfig:
    ...
    # FIX (Feb 2026): Changed from 0DTE to 2DTE minimum. 0DTE SPY $2-wide ICs
    # have virtually no premium (bid=0, credit=$0.02) causing garbage orders.
    # 2DTE gives 2 trading days of theta to collect real premium.
    min_dte: int = 2  # Minimum 2 trading days to expiration
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> 'FortressConfig':
