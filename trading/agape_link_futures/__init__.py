"""
AGAPE-LINK-FUTURES - LINK Futures Contract Trading Bot

Named after the biblical Greek term for "unconditional love" (agape),
AGAPE-LINK-FUTURES extends AGAPE's disciplined, data-driven crypto trading to
LINK futures contracts.

AGAPE-LINK-FUTURES trades LINK-FUT futures contracts 24/7,
...
Key differences from futures (AGAPE-XRP, AGAPE-BTC):
    ...
    - Quantity-based sizing (LINK units, not contracts)
