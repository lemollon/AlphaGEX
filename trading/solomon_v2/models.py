"""
SOLOMON V2 - Data Models
========================

Clean, minimal data models for SOLOMON trading bot.
...
class SolomonConfig:
    """
    SOLOMON configuration - all settings in one place.
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> 'SolomonConfig':
