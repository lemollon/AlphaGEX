"""
AGAPE-SHIB Models - Data structures for the SHIB Perpetual Contract bot.
...
@dataclass
class AgapeShibConfig:
    """Configuration for AGAPE-SHIB bot.
    ...
    @classmethod
    def load_from_db(cls, db) -> "AgapeShibConfig":
...
@dataclass
class AgapeShibSignal:
    """Trading signal generated by AGAPE-SHIB signal engine."""
    spot_price: float
    timestamp: datetime
...
@dataclass
class AgapeShibPosition:
    """An open or closed AGAPE-SHIB position."""
    position_id: str
    side: PositionSide
    quantity: float
    entry_price: float
