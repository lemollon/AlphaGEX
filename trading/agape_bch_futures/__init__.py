"""
AGAPE-BCH-FUTURES - BCH Futures Contract Trading Bot

Named after the biblical Greek term for "unconditional love" (agape),
AGAPE-BCH-FUTURES extends AGAPE's disciplined, data-driven crypto trading to
BCH futures contracts.

AGAPE-BCH-FUTURES trades BCH-FUT futures contracts 24/7,
...
Key differences from futures (AGAPE-XRP, AGAPE-BTC):
    ...
    - Quantity-based sizing (BCH units, not contracts)
