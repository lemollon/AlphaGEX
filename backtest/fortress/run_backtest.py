...
# === DATABASE CONNECTION — ORAT BACKTEST DB ===
# Uses ORAT_DATABASE_URL env var. Falls back to hardcoded URL if not set.
# NEVER use DATABASE_URL here — that points to the production AlphaGEX DB on Render.
DEFAULT_DB_URL = os.environ.get('ORAT_DATABASE_URL') or \
