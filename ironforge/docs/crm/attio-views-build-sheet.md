...
| 3 | Enrollment Pipeline | People (Kanban) | P0 | **Built** — optional: add the 4-value Or filter to hide the "No stage" column |
...
| 7 | Founding Member Outreach | List | P1 | **Built** — view "Outreach Queue", all 5 columns + sort |
