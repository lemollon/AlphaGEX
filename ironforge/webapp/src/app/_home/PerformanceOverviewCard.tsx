 ...
 * from this codebase four separate times. They are NOT reproduced here, and if
 ...
 *
 * It was deleted on 2026-08-25 for a static SVG drawing (HeroChartIllustration,
 * redaction bars instead of values) and restored the same day: Leron asked for
 * the mock's numbers, with the explicit qualifier "it does need real numbers".
 * A drawing was the wrong answer to that, and burning the mock's figures into
 * one would have been worse still — a number inside a picture cannot be
 * grepped, tested, or caught in review. Reading the ledger is the only version
 * of this card that satisfies both halves of the ask. Do not re-swap it for a
 * drawing without a shorter record to hide, and never for a hardcoded figure.
 *
