  ...
  return (
    <div className="relative rounded-2xl border border-white/10 bg-[#0A0B0C] p-3 shadow-2xl shadow-black/60">
      ...
      <div className="grid grid-cols-4 divide-x divide-white/10 rounded-xl border border-white/10 bg-[#0C0D0E]">
        <div className="p-3.5">
          <div className="text-[10px] font-semibold uppercase tracking-wider text-[#4ADE80]">Spark Agent Status</div>
        ...
        <div className="p-3.5">
          ...
          <div className="mt-1.5 text-lg font-bold text-[#4ADE80]">{d?.avgReturn ?? PLACEHOLDER}</div>
        ...
        <div className="p-3.5">
          ...
          <div className="mt-1.5 flex items-center gap-2">
            <ChartCircleIcon className="h-6 w-6 shrink-0 text-[#4ADE80]" />
                ...
                <tr key={t?.closed_date ?? i} className="border-t border-white/5">
                  ...
                  <td
                    className={`py-2 font-semibold ${
                      t?.outcome === 'win' ? 'text-[#4ADE80]' : t?.outcome ? 'text-gray-300' : 'text-gray-500'
                    }`}
                  >
