...
const bots = [
  ...
  },
  {
    ...
    href: '/flare',
    dte: '0DTE',
    desc: '0DTE directional debit verticals driven by live GEX structure. Wall-fade, wall-break, and flip-cross setups — same signal engine as BLAZE, same-day expiration.',
    border: 'border-fuchsia-500/30 hover:border-fuchsia-400/60',
    heading: 'text-fuchsia-400',
    btn: 'border-fuchsia-500/60 text-fuchsia-400 hover:bg-fuchsia-500/10',
