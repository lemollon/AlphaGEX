    ...
    <div className="space-y-10">
      ...
      <div className="text-center mt-2">
        ...
        <div className="flex justify-center gap-2 mt-5">
          <a
            href="/"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-md border border-amber-500/40 bg-amber-500/10 text-amber-300 text-xs font-bold tracking-[0.15em] uppercase hover:bg-amber-500/20 hover:border-amber-500/60 transition"
          >
            View live landing page <span aria-hidden>→</span>
          </a>
          <a
            href="/landing/index.html"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-md border border-white/15 bg-white/5 text-white/70 text-xs font-bold tracking-[0.15em] uppercase hover:bg-white/10 transition"
          >
            All design demos
          </a>
        </div>
