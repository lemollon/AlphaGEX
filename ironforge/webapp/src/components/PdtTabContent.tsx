...
export default function PdtTabContent({
  bot,
  pdtData,
  botStatus,
  onPdtUpdate,
  ...
  const fetchAudit = useCallback(async () => {
    try {
      ...
      console.error(`[PdtTab] audit fetch failed for ${bot}:`, e instanceof Error ? e.message : e)
    }
  }, [bot])
  ...
  async function doToggle(enabled: boolean) {
    ...
    try {
      ...
      console.error(`[PdtTab] toggle failed:`, e instanceof Error ? e.message : e)
    } finally {
      setLoading(false)
    }
  }
  ...
  async function doReset() {
    ...
    try {
      ...
      console.error(`[PdtTab] reset failed:`, e instanceof Error ? e.message : e)
    } finally {
      setLoading(false)
    }
  }
  ...
  if (!pdtData) {
    return (
      <div className="rounded-xl border border-forge-border bg-forge-card/80 p-6 space-y-4">
        <div className="h-12 bg-forge-border/40 rounded-lg skeleton-pulse" />
        <div className="h-8 bg-forge-border/30 rounded w-3/4 skeleton-pulse" />
        <div className="h-32 bg-forge-border/20 rounded-lg skeleton-pulse" />
        <div className="h-20 bg-forge-border/20 rounded-lg skeleton-pulse" />
        <div className="h-6 bg-forge-border/20 rounded w-1/2 skeleton-pulse" />
      </div>
    )
  }

  const status = pdtData
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-forge-border bg-forge-card/80 p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span className="text-xs text-forge-muted uppercase tracking-wide">PDT Enforcement</span>
      ...
      <div className="rounded-xl border border-forge-border bg-forge-card/80 p-4 space-y-3">
        ...
        <div className="border-t border-forge-border/50 pt-3">
          <button
...
function StatusBanner({
  ...
  if (pdtStatus === 'PDT_OFF') {
    bg = 'bg-gray-800/50 border border-gray-500/30'
    ...
    bg = 'bg-amber-900/30 border border-amber-500/30'
    ...
    bg = 'bg-emerald-900/40 border border-emerald-500/30'
  ...
  return (
    <div className={`rounded-xl px-4 py-3 flex items-center gap-3 ${bg}`}>
...
function SlotExpiryTimeline({
  ...
  return (
    <div className="rounded-xl border border-forge-border bg-forge-card/80 p-4">
      <div className="text-[11px] text-forge-muted uppercase tracking-wide font-medium mb-3">
