...
# Console-based output (no streamlit dependency)
import os
import logging
...
class SessionState:
    """Mock session state with attribute access"""
    _state = {}
...
class Secrets:
    """Mock secrets from environment variables"""
...
class MockStreamlit:
    """Mock streamlit for console/API contexts"""
