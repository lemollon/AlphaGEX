#!/usr/bin/env python3
"""
Discernment Automated Outcome Tracker

This module automatically tracks the outcomes of Discernment predictions by:
...
5. Recording outcomes in the discernment_outcomes table

This enables the Discernment performance metrics to actually show data!

CREATED: January 2026
FIX: Discernment Model performance 30 days wasn't showing data because
...
def record_outcome(
    ...
    try:
        ...
        ''', (
            ...
            direction_correct,
            magnitude_correct,
            'Auto-tracked by discernment_outcome_tracker'
        ))
...
def track_discernment_outcomes(min_age_hours: int = 24, max_age_days: int = 7) -> Dict:
    """
    ...
    """
    logger.info("=" * 60)
    logger.info("DISCERNMENT OUTCOME TRACKER - Starting")
    logger.info("=" * 60)
    ...
    logger.info("=" * 60)
    logger.info(f"DISCERNMENT OUTCOME TRACKER - Complete")
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("DISCERNMENT OUTCOME TRACKER - Manual Run")
    print("=" * 60)
