# ANCHOR Anomaly Analysis Report
...
ANCHOR shows highly suspicious trading metrics:
...
**File**: `trading/anchor/signals.py:571-596`
...
**File**: `trading/anchor/executor.py:546-581`
...
**File**: `trading/anchor/executor.py:644-688`
...
**File**: `trading/anchor/models.py:218`
...
**File**: `trading/anchor/executor.py:460-522`
...
| File | Changes |
|------|---------|
| `trading/anchor/models.py` | Enable stop_loss, add realistic defaults |
| `trading/anchor/signals.py` | Use real option prices for credits |
| `trading/anchor/executor.py` | Use MTM for paper closes, fix position sizing |
| `trading/anchor/trader.py` | Add position monitoring during trading day |

## Conclusion

The ANCHOR anomaly is NOT a single bug but a combination of:
