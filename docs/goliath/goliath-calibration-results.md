...
**Notes:** universe SE 0.443 > 0.15 -- calibration too noisy to act on. Recommend extending window to 180d before re-running. Universe mean ratio 0.770 (median 0.801), n=5.
