-- ARGUS Tables Migration
-- Creates tables for ARGUS (0DTE Gamma Live) - Real-time gamma visualization and predictions
-- Run: psql $DATABASE_URL -f db/migrations/005_argus_tables.sql

-- ============================================================================
-- ARGUS SNAPSHOTS TABLE
...
CREATE INDEX IF NOT EXISTS idx_argus_snapshots_time ON argus_snapshots(snapshot_time);
CREATE INDEX IF NOT EXISTS idx_argus_snapshots_expiration ON argus_snapshots(expiration_date);
CREATE INDEX IF NOT EXISTS idx_argus_snapshots_symbol ON argus_snapshots(symbol);
...
-- ============================================================================
-- ARGUS COMMENTARY TABLE
-- Stores Claude AI commentary generated every 5 minutes
-- ============================================================================
CREATE TABLE IF NOT EXISTS argus_commentary (
    id SERIAL PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_argus_commentary_time ON argus_commentary(created_at);
CREATE INDEX IF NOT EXISTS idx_argus_commentary_snapshot ON argus_commentary(snapshot_id);
...
CREATE INDEX IF NOT EXISTS idx_argus_alerts_time ON argus_alerts(triggered_at);
CREATE INDEX IF NOT EXISTS idx_argus_alerts_type ON argus_alerts(alert_type);
CREATE INDEX IF NOT EXISTS idx_argus_alerts_priority ON argus_alerts(priority);

-- ============================================================================
-- ARGUS PREDICTIONS TABLE
...
-- VERIFICATION
-- ============================================================================
SELECT 'ARGUS tables created successfully' as status;
