-- ============================================================
-- Migration 011: Update ATHENA config to Apache backtest parameters
-- Date: 2025-01-09
--
-- This migration updates ATHENA to use the profitable parameters
...
INSERT INTO autonomous_config (bot_name, config_key, config_value)
VALUES ('ATHENA', 'min_rr_ratio', '1.5')
...
INSERT INTO autonomous_config (bot_name, config_key, config_value)
VALUES ('ATHENA', 'min_gex_ratio_bearish', '1.5')
ON CONFLICT (bot_name, config_key) DO UPDATE SET config_value = '1.5', updated_at = NOW();

INSERT INTO autonomous_config (bot_name, config_key, config_value)
VALUES ('ATHENA', 'max_gex_ratio_bullish', '0.67')
