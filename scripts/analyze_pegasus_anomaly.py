#!/usr/bin/env python3
"""
PEGASUS ANOMALY DEEP ANALYSIS
=============================

Investigates the suspicious 97.4% win rate and identical P&L amounts in PEGASUS trades.
...
def main():
    print("=" * 80)
    print("PEGASUS ANOMALY DEEP ANALYSIS")
    ...
    # Analyze PEGASUS
    pegasus_stats = analyze_pnl_distribution(cursor, "PEGASUS", "pegasus_positions")
    if pegasus_stats:
        analyze_close_reasons(cursor, "pegasus_positions")
