#!/usr/bin/env python3
"""
Auto ARES Trade - No Manual Confirmation Required
=================================================

Automatically triggers ARES to execute a trade without requiring manual input.
...
def main():
    parser = argparse.ArgumentParser(description='Auto ARES Trade (No Manual Confirmation)')
    ...
    try:
        ...
        print(f"\n🚀 Initializing ARES in {mode.value} mode...")

        ares = ARESTrader(mode=mode, initial_capital=200_000)
        ...
        # Get Tradier status
        print(f"\n💰 Tradier Connection:")
        tradier_status = ares.get_tradier_account_status()
