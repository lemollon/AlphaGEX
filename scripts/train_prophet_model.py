...
=============================
Run this in Render Shell to manually train the Prophet ML model.

Usage:
    python scripts/train_prophet_model.py              # Train if needed
    python scripts/train_prophet_model.py --force      # Force retrain

This will:
1. Check training data availability (live outcomes → backtests → CHRONICLES)
    ...
    try:
        ...
        if result.get('success'):
            ...
            if result.get('reason') == 'insufficient_data':
                ...
                print("   3. Check CHRONICLES memory table")
