#!/usr/bin/env python3
"""
PROMETHEUS Tradier Verification Script
=======================================

Run this on Render shell to verify PROMETHEUS is getting LIVE SPX data:
...
def main():
    print(f"\n{BOLD}PROMETHEUS TRADIER VERIFICATION{RESET}")
    ...
    # ================================================================
    print_header("5. PROMETHEUS SIGNAL GENERATOR TEST")
    # ================================================================

    try:
        from trading.prometheus.signals import _get_tradier, BoxSpreadSignalGenerator
        ...
        print_result("PROMETHEUS Signal Generator", False, str(e))
        results["failed"] += 1

    # ================================================================
    print_header("6. PROMETHEUS IC SIGNAL GENERATOR TEST")
    # ================================================================

    try:
        from trading.prometheus.signals import PrometheusICSignalGenerator
        ...
        print_result("PROMETHEUS IC Signal Generator", False, str(e))
        results["failed"] += 1
    ...
    if results["failed"] == 0:
        print(f"\n{GREEN}{BOLD}ALL TESTS PASSED! PROMETHEUS is using LIVE SPX data.{RESET}")
        return 0
    else:
