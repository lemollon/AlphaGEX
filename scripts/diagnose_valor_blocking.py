#!/usr/bin/env python3
"""
VALOR Signal Blocking Diagnostic

This script checks ALL conditions that could prevent VALOR from generating trades:
...
def diagnose():
    """Run full diagnostic on VALOR signal blocking."""
    print("=" * 70)
    print("VALOR SIGNAL BLOCKING DIAGNOSTIC")
    print("=" * 70)
    ...
    try:
        ...
        if flip_point > 0:
            ...
            print("  VALOR will SKIP all signals when flip_point is 0")
            return
    ...
    try:
        from trading.valor.signals import get_direction_tracker
