...
print("=" * 70)
print("HERACLES (VALOR) UPDATES VALIDATION")
print("=" * 70)
...
try:
    ...
    from trading.heracles.models import HERACLESConfig, GammaRegime, BayesianWinTracker
...
try:
    from trading.heracles.ml import HERACLESMLAdvisor, get_heracles_ml_advisor
...
try:
    from trading.heracles.signals import _get_ml_advisor
...
1. Check /api/heracles/diagnostics for dynamic_stop info
2. Check /api/heracles/ml/status for model status
