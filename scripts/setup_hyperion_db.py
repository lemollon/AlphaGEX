#!/usr/bin/env python3
"""
Setup script for HYPERION ROC persistence database table.
...
ensures it's ready before users access HYPERION.
"""
...
def setup_hyperion_tables():
    """Create HYPERION gamma history table and indexes."""
    print("Setting up HYPERION database tables...")
