#!/usr/bin/env python3
"""
ICARUS Loss Diagnostic Script
==============================

Comprehensive analysis to figure out why ICARUS is still losing.
...
def main():
    print("\n" + "="*70)
    print(" ICARUS LOSS DIAGNOSTIC REPORT")
    ...
    query = """
        SELECT COUNT(*) FROM icarus_positions
