#!/usr/bin/env python3
"""
ARES Signal Debug Script
=========================

Traces through the EXACT signal generation flow to find why ARES isn't trading.

Run on Render shell:
    python scripts/debug_ares_signal.py
"""
...
def main():
    print_section("ARES SIGNAL DEBUG")
