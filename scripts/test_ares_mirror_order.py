#!/usr/bin/env python3
"""
Test script to place a test order on the second ARES sandbox account.
...
def test_second_account_order():
    ...
    api_key_2 = os.getenv('TRADIER_ARES_SANDBOX_API_KEY_2')
    account_id_2 = os.getenv('TRADIER_ARES_SANDBOX_ACCOUNT_ID_2')
...
def check_ares_executor_accounts():
    """Check what accounts the ARES executor is using."""
    print("\n" + "=" * 60)
    print("  CHECKING ARES EXECUTOR ACCOUNT CONFIGURATION")
    print("=" * 60)
...
def main():
    print("\n" + "=" * 60)
    print("  ARES MIRROR ORDER TEST")
    print("=" * 60)

    # Test 1: Check ARES executor account configuration
    check_ares_executor_accounts()
