...
def get_fortress_trades(conn, target_date: str) -> list:
    """Get all FORTRESS trades for a specific date"""
    c = conn.cursor()
...
def main():
    parser = argparse.ArgumentParser(description='Investigate FORTRESS loss')
    ...
    print(f"\n{'='*80}")
    print(f" FORTRESS LOSS INVESTIGATION - {target_date}")
    print(f"{'='*80}")
