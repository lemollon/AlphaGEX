#!/usr/bin/env python3
"""
ICARUS Analysis 02: Oracle Decision Analysis
=============================================
Deep dive into Oracle's predictions and their outcomes.
...
print("\n" + "="*70)
print(" ICARUS ORACLE DECISION ANALYSIS")
print("="*70)

# 1. Oracle Confidence Distribution
section("1. ORACLE CONFIDENCE DISTRIBUTION")
r, _ = query("""
    SELECT
...
# 2. Oracle Advice Values
section("2. ORACLE ADVICE VALUES")
r, _ = query("""
...
# 6. Oracle vs Actual Outcome
section("6. ORACLE PREDICTION VS ACTUAL OUTCOME")
r, _ = query("""
    SELECT
        ml_direction,
        spread_type,
...
r, _ = query("""
    ...
    FROM icarus_positions WHERE status = 'closed'
""")
if r:
    print(f"\n  Oracle confidence > 1.0: {r[0][1]} trades")
...
# 9. Recent Oracle Decisions
section("9. RECENT 15 ORACLE DECISIONS")
r, _ = query("""
    SELECT
        position_id,
        spread_type,
