#!/usr/bin/env python3
"""
Test script to manually push a trade to Tradier via ARES.
...
def main():
    parser = argparse.ArgumentParser(description='Test ARES trade to Tradier')
