#!/usr/bin/env python3
"""
ARES Full Cycle Debug Script
==============================

Runs a complete ARES cycle and traces every step.
...
def main():
    ...
    try:
        ...
        from trading.ares_v2.models import TradingMode

        print("[1] Initializing ARES trader...")
        trader = ARESTrader(mode=TradingMode.PAPER)
        ...
        logger = logging.getLogger('trading.ares_v2')
        ...
        if details:
            ...
            if details.get('oracle_suggests_athena'):
                print(f"    Oracle Suggests ATHENA: {details['oracle_suggests_athena']}")
