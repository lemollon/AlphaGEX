#!/bin/bash
#
# Quick WATCHTOWER API tests using curl
...
echo "========================================"
echo "WATCHTOWER API Tests (curl)"
echo "========================================"
echo ""
...
# Run tests
test_endpoint "Main Gamma" "/api/watchtower/gamma"
test_endpoint "Strike Trends" "/api/watchtower/strike-trends"
test_endpoint "Gamma Flips" "/api/watchtower/gamma-flips"
test_endpoint "Danger Zone Logs" "/api/watchtower/danger-zones/log"
test_endpoint "Expirations" "/api/watchtower/expirations"
test_endpoint "Alerts" "/api/watchtower/alerts"
test_endpoint "Context" "/api/watchtower/context"
