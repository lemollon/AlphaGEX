...
def test_bots_registered():
    assert set(BOT_REGISTRY.keys()) == {"surge", "splash", "ripple", "tide", "drift", "flow", "meadow", "undertow",
         ...
         "afterburn", "weekender", "flashpoint", "thermal"}
...
def test_list_bots_returns_keys():
    assert sorted(list_bots()) == ["afterburn", "backdraft", "delta", "drift", "embreach", "embreachq",
         "flashpoint", "flow", "meadow", "reversal", "ripple", "splash",
         "surge", "thermal", "tide", "undertow", "updraft", "weekender"]
