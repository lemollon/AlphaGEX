"""Tests for backend.bots.tsunami.monitoring.discord."""
...
from backend.bots.tsunami.monitoring import discord  # noqa: E402
...
class PayloadShape(unittest.TestCase):
    def test_payload_is_valid_discord_shape(self):
        ...
        self.assertEqual(body["username"], "TSUNAMI")
...
class EmbedBuilders(unittest.TestCase):
    def test_entry_embed_has_strike_fields(self):
        ...
        self.assertIn("TSUNAMI-MSTU", embed["title"])
    ...
    def test_kill_embed_uses_kill_color(self):
        embed = discord.build_kill_embed("INSTANCE", "TSUNAMI-MSTU", "I-K1", "drawdown 35%")
