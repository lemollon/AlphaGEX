"""Tests for backend.bots.tsunami.management.triggers.t8_underlying_gex_flip."""
...
from backend.bots.tsunami.management.triggers.t8_underlying_gex_flip import (  # noqa: E402
    evaluate,
)
