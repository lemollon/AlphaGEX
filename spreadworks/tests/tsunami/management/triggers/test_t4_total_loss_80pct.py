"""Tests for backend.bots.tsunami.management.triggers.t4_total_loss_80pct."""
...
from backend.bots.tsunami.management.triggers.t4_total_loss_80pct import (  # noqa: E402
