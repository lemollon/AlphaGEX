"""Tests for backend.bots.tsunami.management.triggers.t5_short_strike_breach_3dte."""
...
from backend.bots.tsunami.management.triggers.t5_short_strike_breach_3dte import (  # noqa: E402
    DTE_THRESHOLD,
    evaluate,
)
...
def _position(*, short_put=9.0, letf_spot=10.0, exp=_FRIDAY) -> Position:
    return Position(
        position_id="p", instance_name="TSUNAMI-TSLL",
