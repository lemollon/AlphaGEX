"""Tests for backend.bots.tsunami.management.cli."""
...
from backend.bots.tsunami.management import cli  # noqa: E402


class CLIFlagNews(unittest.TestCase):
    def test_flag_news_calls_store_with_uppercased_ticker(self):
        with patch("backend.bots.tsunami.management.cli.news_flag_store") as store:
