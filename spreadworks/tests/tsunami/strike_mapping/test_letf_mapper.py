"""Tests for backend.bots.tsunami.strike_mapping.letf_mapper.
...
from backend.bots.tsunami.strike_mapping.letf_mapper import (  # noqa: E402
    LETFTarget,
