"""CLI for TSUNAMI kill-switch manual override.
...
Usage:
    python -m backend.bots.tsunami.kill_switch.cli list-kills
    python -m backend.bots.tsunami.kill_switch.cli override-kill \\
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="tsunami.kill_switch.cli",
        description="TSUNAMI kill-switch manual override CLI.",
    )
    ...
    ov.add_argument("--instance", default=None,
                    help="LETF instance (e.g. TSUNAMI-MSTU); required for INSTANCE scope")
