"""Postgres-backed append-only audit store for TSUNAMI trade events.
...
def insert(
    ...
    try:
        ...
        try:
            cur.execute(
                """
                INSERT INTO tsunami_trade_audit (instance, event_type, data, position_id)
                VALUES (%s, %s, %s, %s)
                """,
