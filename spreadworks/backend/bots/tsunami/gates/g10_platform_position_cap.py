"""Gate G10 -- Total open TSUNAMI positions <= 3 across all instances.

Master spec section 2:
    "Total open TSUNAMI positions <= 3 across all instances --
...
def evaluate(
    ...
    Args:
        open_position_count: total open TSUNAMI positions across all
