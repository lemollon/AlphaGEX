"""Position state machine and shared types for TSUNAMI management.
...
class PositionState(str, Enum):
    """Lifecycle state of a TSUNAMI position."""
...
@dataclass
class Position:
    """An open TSUNAMI position with all data triggers need to evaluate.
