...
Per master spec section 1.5, every TSUNAMI trade is exactly:
...
from backend.bots.tsunami.strike_mapping.letf_mapper import LETFTarget
...
def build_legs(
    ...
    Args:
        ...
        config: TsunamiConfig (currently unused; reserved for v0.3 hooks)
