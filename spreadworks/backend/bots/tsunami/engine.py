"""TsunamiEngine -- wires Phase 2 (strike mapping) + Phase 3 (gates) +
...
[TSUNAMI-DELTA] yellow -- spec adjustment:
...
from .instance import TsunamiInstance
...
class EngineEntryDecision:
    """Output of TsunamiEngine.evaluate_entry."""
...
def _instance_to_tsunami_config(cfg: InstanceConfig) -> TsunamiConfig:
    """Build a TsunamiConfig (Phase 1.5 calibration dataclass) from an
...
class TsunamiEngine:
    ...
    def evaluate_entry(
        ...
        config = _instance_to_tsunami_config(instance.config)
