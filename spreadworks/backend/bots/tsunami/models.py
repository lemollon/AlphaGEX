"""TSUNAMI dataclasses and enums.

Phase 1.5 minimal scope: TsunamiConfig with the 4 calibration parameters
...
@dataclass
class TsunamiConfig:
    """Per-instance TSUNAMI configuration.

    A TSUNAMI "instance" is a tuple (LETF, underlying) — e.g.
    TSUNAMI-MSTU trades MSTU options using GEX data from MSTR.
    ...
    instance_name: str       # e.g. "TSUNAMI-MSTU"
