...
const bots = [
  ...
  },
  {
    ...
    href: '/inferno',
    dte: '0DTE',
    desc: 'FORTRESS-style 0DTE Iron Condors. Unlimited trades per day with multiple simultaneous positions.',
    ...
    <div className="space-y-10">
      ...
      <div className="text-center mt-2">
        ...
        <p style={{
          ...
          maxWidth: '420px',
          margin: '0 auto',
          textShadow: '0 0 10px rgba(251,191,36,0.5), 0 0 24px rgba(245,158,11,0.3), 0 0 40px rgba(217,119,6,0.15)',
        }}>
          &ldquo;As iron sharpens iron, so one person sharpens another.&rdquo;
          <br />
          <span style={{ fontSize: '0.7rem', letterSpacing: '0.15em', color: '#F59E0B', textShadow: '0 0 8px rgba(245,158,11,0.5)' }}>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-forge-border/50">
              {[
                ...
                { param: 'Profit Target', flame: '30/20/15%', spark: '30/20/15%', inferno: '50/30/10%' },
                { param: 'Stop Loss', flame: '100%', spark: '100%', inferno: '200%' },
                { param: 'Max Contracts', flame: '10', spark: '10', inferno: 'No limit' },
                { param: 'Max Trades/Day', flame: '1', spark: '1', inferno: 'No limit' },
