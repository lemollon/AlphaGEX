#!/usr/bin/env python3
"""
HERACLES Overnight Hybrid Strategy and Gamma Regime Filter Tests
=================================================================
...
from trading.heracles.models import (
    HERACLESConfig, GammaRegime, TradeDirection, FuturesSignal, SignalSource,
...
class TestEmergencyStopCalculation:
    ...
    def test_emergency_stop_distance_from_initial_stop(self):
        ...
        from trading.heracles.models import FuturesPosition, PositionStatus
