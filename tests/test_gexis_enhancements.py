...
class TestCacheConvenienceFunctions:
    ...
    def test_cache_market_data(self):
        ...
        from ai.gexis_cache import cache_market_data, get_cached_market_data, gexis_cache
    ...
    def test_cache_gex_data(self):
        ...
        from ai.gexis_cache import cache_gex_data, get_cached_gex_data, gexis_cache
    ...
    def test_invalidate_positions_cache(self):
        ...
        from ai.gexis_cache import cache_positions, get_cached_positions, invalidate_positions_cache, gexis_cache
...
class TestGEXISTracer:
    """Test the GEXIS tracing system."""

    @pytest.fixture
    def tracer(self):
        """Create a fresh tracer instance for each test."""
        from ai.gexis_tracing import GEXISTracer
...
class TestRequestContext:
    ...
    def test_request_context(self):
        ...
        from ai.gexis_tracing import RequestContext
...
class TestMarketHoursCommand:
    ...
    def test_market_hours_info_structure(self):
        ...
        from ai.gexis_commands import get_market_hours_info
    ...
    def test_execute_market_hours_command(self):
        ...
        from ai.gexis_commands import execute_market_hours_command
    ...
    def test_market_holidays_are_defined(self):
        ...
        from ai.gexis_commands import MARKET_HOLIDAYS_2025
...
class TestStrategyPerformanceCommand:
    ...
    def test_strategy_performance_structure(self):
        ...
        from ai.gexis_commands import get_strategy_performance
    ...
    def test_execute_strategy_performance_command(self):
        ...
        from ai.gexis_commands import execute_strategy_performance_command
...
class TestSuggestionCommand:
    ...
    @patch('ai.gexis_tools.fetch_ares_market_data')
    @patch('ai.gexis_tools.get_upcoming_events')
    @patch('ai.gexis_tools.is_market_open')
    def test_generate_trade_suggestion(
        self, mock_market_open, mock_events, mock_market_data
    ):
        """Test trade suggestion generation."""
        from ai.gexis_commands import generate_trade_suggestion
    ...
    @patch('ai.gexis_commands.generate_trade_suggestion')
    def test_execute_suggestion_command(self, mock_generate):
        """Test executing the suggestion command."""
        from ai.gexis_commands import execute_suggestion_command
        from ai.gexis_cache import gexis_cache
...
class TestRiskCommand:
    ...
    def test_get_portfolio_risk_structure(self):
        ...
        from ai.gexis_commands import get_portfolio_risk
    ...
    def test_execute_risk_command(self):
        ...
        from ai.gexis_commands import execute_risk_command
...
class TestExtendedCommandRegistry:
    ...
    def test_extended_commands_defined(self):
        ...
        from ai.gexis_commands import EXTENDED_COMMANDS
    ...
    def test_execute_extended_command(self):
        ...
        from ai.gexis_commands import execute_extended_command
...
class TestGEXISEnhancementsIntegration:
    """Integration tests for GEXIS enhancements."""

    def test_cache_with_tracing(self):
        """Test that caching works with tracing enabled."""
        from ai.gexis_cache import gexis_cache, GEXISCache
        from ai.gexis_tracing import gexis_tracer

        gexis_cache.clear()

        with gexis_tracer.trace("integration.cache_test") as span:
            # First call - cache miss
            result1 = gexis_cache.get("integration_key")
            span.add_event("cache_miss", {"key": "integration_key"})

            # Set value
            gexis_cache.set("integration_key", {"test": True}, ttl=60)
            span.add_event("cache_set", {"key": "integration_key"})

            # Second call - cache hit
            result2 = gexis_cache.get("integration_key")
    ...
    def test_full_command_flow(self):
        ...
        from ai.gexis_commands import execute_extended_command
        from ai.gexis_cache import gexis_cache
        from ai.gexis_tracing import gexis_tracer, RequestContext
        ...
        # Verify cache stats
        cache_stats = gexis_cache.get_stats()
...
class TestPerformance:
    """Performance tests for GEXIS enhancements."""
...
class TestTokenBucket:
    ...
    def test_token_bucket_initial_state(self):
        ...
        from ai.gexis_rate_limiter import TokenBucket
