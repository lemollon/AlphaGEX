...
def run_all_tests():
    ...
    if failed == 0:
        ...
        print("  - Market hours: 'VALOR GEX from TRADIER (market hours)'")
        print("  - Overnight: 'VALOR GEX from TradingVolatility (overnight)'")
